...
* [Pool Toys](https://calittle.github.io/pages/pooltoys) - Arduino-based WiFi enabled pool thermometer that logs data to an external data collection [service](https://io.adafruit.com/fenbranklin/feeds/tsfeed), and makes that data available to your Alexa device via a [Lambda](https://github.com/calittle/pooltoys/tree/master/alexa-skill) function. You can ![ask](https://github.com/calittle/pooltoys/blob/274c4e4fcb3abcc7e94523fdc5aeca3efb70da66/alexa-skill/alexa.m4a) your Alexa-enabled device to report the current temperature reading.
